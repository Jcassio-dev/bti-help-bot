...
function connectToWhatsApp() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, baileys_1.useMultiFileAuthState)(path.resolve(__dirname, "..", "..", "auth_info_baileys"))];
                case 1:
                    ...
                    sock.ev.on("connection.update", function (update) {
                        ...
                        if (connection === "close") {
                            var shouldReconnect = ((_b = (_a = lastDisconnect === null || lastDisconnect === void 0 ? void 0 : lastDisconnect.error) === null || _a === void 0 ? void 0 : _a.output) === null || _b === void 0 ? void 0 : _b.statusCode) !==
                            ...
                            (0, handlers_1.handleMessages)(sock);
                        }
                    });
